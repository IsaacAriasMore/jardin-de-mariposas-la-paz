...
const googleMapsDestination = encodeURIComponent(business.location.plusCode);
...
const DEFAULT_GOOGLE_MAPS_URL = `https://www.google.com/maps/search/?api=1&query=${googleMapsDestination}`;

const DEFAULT_GOOGLE_MAPS_DIRECTIONS_URL = `https://www.google.com/maps/dir/?api=1&destination=${googleMapsDestination}`;
...
module.exports = {
  ...
  googleMapsDirectionsUrl:
    process.env.GOOGLE_MAPS_DIRECTIONS_URL || DEFAULT_GOOGLE_MAPS_DIRECTIONS_URL,
};
